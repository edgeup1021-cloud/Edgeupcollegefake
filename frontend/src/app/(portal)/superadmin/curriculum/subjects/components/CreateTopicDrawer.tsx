...
export default function CreateTopicDrawer({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch(`http://localhost:3001/api/curriculum/subjects/${subjectId}/topics`, {
        method: 'POST',
      ...
      onError(error.message || "Failed to create topic. Please try again.");
    } finally {
  ...
  return (
    <Modal isOpen={isOpen} onClose={handleClose} title="Create New Topic" size="md">
