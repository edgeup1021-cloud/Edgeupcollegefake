...
import { SupportedLanguage, TestCase, TestResult } from "@/types/mock-interview.types";
import { LANGUAGE_CONFIG } from "@/lib/mock-interview/languageConfig";
import { generateTestHarness, extractFunctionName } from "@/lib/mock-interview/testHarness";
