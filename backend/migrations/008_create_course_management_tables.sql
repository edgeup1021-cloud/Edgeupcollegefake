-- ====================================================================
-- Migration: Create all course management tables
-- Database: edgeup_super_admin
-- Description: Creates all tables for the course management system
--              University → Program → Department/Semester → Subject → Topic → Subtopic
-- ====================================================================
